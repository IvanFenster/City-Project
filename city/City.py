...
# Функция определяет колонку по номеру вершины варианта
def define_col(vert):
    k = vert % 18
    if k <= 9:
        t = k // 2
...
# Проверка если машины не могут сдвинуться из-за друг друга
